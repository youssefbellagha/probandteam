...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark " style="direction: rtl">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav w-100 d-flex">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="mailto:montaser.alfrookh@gmail.com">الوظائف</a>
            </li>
            <li class="nav-item ">
                ...
                <div class="item ">
                    ...
                    <div class="caption text-center">
                        <div class="caption2 p-2">
                            <h4 class="">{{ $agent->formattedName() }}</h4>
                            <p><a href="mailto:{{$agent->email}}">{{$agent->email}}</a></p>
                            <p>{{$agent->phone}}</p>
                            <div class="icons-agentm">
                                <a href="{{ $agent->facebook }}"><i class="fab fa-facebook-f px-1"></i></a>
                                <a href="{{ $agent->twitter }}"><i class="fab fa-twitter px-1"></i></a>
                                <a href="{{ $agent->github }}"><i class="fab fa-github px-1"></i></a>
                                <a href="{{ $agent->instagram }}"><i class="fab fa-instagram px-1"></i></a>
                            </div>
                            <p>{{ $agent->Countrie->flag }}{{ $agent->Countrie->name }} - {{ $agent->Citie->name }} </p>
                        </div>
                    </div>
                </div>
                @endforeach
